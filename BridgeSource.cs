...
{
	public class BridgeSource : MonoBase
	{
		float blockWidth = 1.6f;
		public static BridgeSource globalController;
		...
		void OnStart()
		{
			...
			//bridgeRoot = gameObject.FindWithTag("source block");
			red_color = Color.Red;
		...
		{
			ClearBridge();
			Vector3 currentPos = gameObject.transform.Translation; //need this pointer?
