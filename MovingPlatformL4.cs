    ...
    public class MovingPlatformL4 : MonoBase
    {
        ...
        void OnFixedUpdate()
        {
            ...
            if (direction == 1)
            {
                ...
                newPos = Vector3.MoveTowards(transformComponent.Translation, destinVec, moveSpeed * Time.deltaTime);
            ...
            if (direction == -1)
            {
                ...
                newPos = Vector3.MoveTowards(transformComponent.Translation, startPos, moveSpeed * Time.deltaTime);
                rb.AddForce((newPos - transformComponent.Translation) * moveSpeed);
